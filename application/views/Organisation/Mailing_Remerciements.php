...
<h2 align='center' class='textBlanc'> <b> Envoi d'email à tout les sponsors de l'année actuel (remerciements) </b></h2>
<?php
...
?>
<br>
<input type='submit' name='submit' class='btn btn-primary' value ="Envoyer à tout les sponsors de l'année en cours">
</table>
